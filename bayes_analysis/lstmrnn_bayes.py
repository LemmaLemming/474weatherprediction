...
# Set the log filename for LSTM model
log_filename = "bayes_lstm.csv"
...
def objective(**params):
    trial_counter[0] += 1
    print(f"\n--- Trial #{trial_counter[0]} (LSTM Model) ---")
    print("Params:", params)
    ...
    for fold_idx, (train_idx, val_idx) in enumerate(splits):
        ...
        model = Sequential([
            ...
            LSTM(int(params['units']), activation=params['activation']),
...
print("Starting Bayesian optimization for LSTM model...")
res = gp_minimize(
    objective, 
    space, 
    n_calls=20, 
...
summary_filename = "lstm_optimization_summary.csv"
